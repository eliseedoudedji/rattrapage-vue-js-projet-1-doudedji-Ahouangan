...
<template>
  <div class="py-5"></div>
  <TheHeader />
  <section id="mainSection" class="bg-black">
    <div class="py-10 my-5 bg-black"></div>
    ...
    <div class="font-sans px-4">
      <div class="grid lg:grid-cols-2 items-center lg:gap-y-6">
        <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
          <h2 class="lg:text-5xl text-3xl font-bold lg:!leading-[56px]" style="color: blue">
            La plus grande plateforme de gestion de tâche
          </h2>
          <p class="text-white mt-6 text-base leading-relaxed">
            Bienvenue sur notre plateforme robuste et sécurisé conçu pour répondre à vos besoin sur
            la gestion de vos différents tâches grâce à son grande autonomie et son design. Veuillez
            vous inscrire pour explorer la puissance de notre plateforme
          </p>
          <RouterLink to="/register">
            <button
              type="button"
              class="border-2 border-white mt-12 transition-all text-white font-bold text-sm rounded-md px-6 py-2.5"
            >
              S'inscrire
            </button>
          </RouterLink>
        ...
        <div class="lg:h-[500px] flex items-center pl-5">
          <img src="../assets/images/bannier.jpg" class="object-cover" alt="Dining Experience" />
        </div>
      </div>
    ...
    <!-- network logo -->
    <div class="flex justify-start mx-10 px-7">
